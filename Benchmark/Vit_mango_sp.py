...
param_variations = [
    {"PS": ps, "DE": de, "TL": tl, "HDS": hds, "MLP": mlp, "LR": lr}
    for ps, de, tl, hds, mlp,lr in itertools.product(PS, DE, TL, HDS, MLP,LR)
]
paramsets = [{**base_params, **variation} for variation in param_variations]

model_type = "ViT_1D_sp_optimized_3"
