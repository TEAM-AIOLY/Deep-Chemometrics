...
datasets = {
    "Mango": {
        ...
        "y_lab": "dm_mango",
        "model_name": "_CuiNet_Mango_jz"
    },
    "ossl": {
        "data_path": "data/dataset/ossl/ossl_all_L1_v1.2.csv",
        "y_lab": "oc_usda",
        "model_name": "_CuiNet_ossl_jz"
    },
    "Wheat": {
        "data_path": "data/dataset/Wheat/",
        "y_lab": "Wheat_dt",
        "model_name": "_CuiNet_Wheat_jz"
    }
}
...
param_variations = [
    {"LR": lr, "DP": dp, "dp_lay": dp_lay}
    for lr, dp, dp_lay in itertools.product(lr_values, dp_values, dp_lay_values)
]
