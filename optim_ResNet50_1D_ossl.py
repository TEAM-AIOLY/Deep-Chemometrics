...
from net.base_net import ResNet50_1D
...
def objective(trial, params):
    ...
    model = ResNet50_1D(mean=params['mean'], std=params['std'], out_dims=len(params['y_labels']),dropout=DP, inplanes=IP)
...
if __name__ == "__main__":
    ...
    param_file = os.path.dirname(data_path)+ '/optuna_params/optuna_ResNet50_params_mir.json'
